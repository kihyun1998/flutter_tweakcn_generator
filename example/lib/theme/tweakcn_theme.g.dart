...
class TweakcnShadows extends ThemeExtension<TweakcnShadows> {
  ...
  static const light = TweakcnShadows(
    shadow2xs: [
      BoxShadow(offset: Offset(0.0, 1.0), blurRadius: 0.0, spreadRadius: 0.0, color: Color(0x0D000000)),
    ],
    shadowXs: [
      BoxShadow(offset: Offset(0.0, 1.0), blurRadius: 2.0, spreadRadius: 0.0, color: Color(0x0D000000)),
    ],
    shadowSm: [
    ...
    shadowMd: [
      ...
      BoxShadow(offset: Offset(0.0, 2.0), blurRadius: 4.0, spreadRadius: -2.0, color: Color(0x1A000000)),
    ],
    shadowLg: [
      BoxShadow(offset: Offset(0.0, 10.0), blurRadius: 15.0, spreadRadius: -3.0, color: Color(0x1A000000)),
      BoxShadow(offset: Offset(0.0, 4.0), blurRadius: 6.0, spreadRadius: -4.0, color: Color(0x1A000000)),
    ],
    shadowXl: [
      BoxShadow(offset: Offset(0.0, 20.0), blurRadius: 25.0, spreadRadius: -5.0, color: Color(0x1A000000)),
      BoxShadow(offset: Offset(0.0, 8.0), blurRadius: 10.0, spreadRadius: -6.0, color: Color(0x1A000000)),
    ],
    shadow2xl: [
      BoxShadow(offset: Offset(0.0, 25.0), blurRadius: 50.0, spreadRadius: -12.0, color: Color(0x40000000)),
    ],
  );
